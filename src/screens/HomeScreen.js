                        ...
                        {queue.map((element, i) =>
                            ...
                            mainStyle.dropshadow2]}>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{ fontSize: 30, color: color.softText }}>{element.CountDown}</Text>
                                </View>
                                <View style={{ flexDirection: 'column' }}>
                                    <Text style={{ fontSize: 20, color: color.softText }}>{element.Time}</Text>
